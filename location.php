...
<body>
    ...
    <header id="stickyheaders">
        <nav id="headerInner" class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
              <a class="navbar-brand" aria-label="Header logo" href="."><img id="header-logo" src="assets/images/logo-3.webp" alt="header_logo"></a>
              <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="ourstory" href="ourstory">OUR STORY</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="catering" href="catering">CATERING</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " aria-current="franchise" href="franchise">FRANCHISE</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="location" href="location">LOCATIONS</a>
                          </li>
                        <li class="nav-item">
                            <a class="nav-link " aria-current="contact" href="contact">CONTACT US</a>
                        </li>
                        <li class="nav-item" style="padding:0;">
                            <div class="social-icon-mobile">
                              <div class="icon-container">
                                  <div class="div">
                                      <a target="_blank" aria-label="our facebook" href="https://www.facebook.com/profile.php?id=61550737452869"><img src="assets/images/sm-logo/fb.png" alt="icon"></a>
                                      <a target="_blank" aria-label="our instagram" href="https://www.instagram.com/telugu_aromas/?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"><img src="assets/images/sm-logo/insta.png" alt="icon"></a>
                                      <a target="_blank" aria-label="our twitter" href="https://www.youtube.com/channel/UCaHxvSy_XUrWP9vovhTKQWA"><img src="assets/images/sm-logo/youtube.png" alt="icon"></a>
                                      <a target="_blank" aria-label="our threads" href="https://www.threads.net/@telugu_aromas"><img src="assets/images/sm-logo/threads.png" alt="icon"></a>
                                    </div>
                              </div>
                          </div>
                        </li>
    ...
    <section class="locations-main-container">
        ...
        <div class="locations-main-body">
                ...
                <div class="location-image">
                    <div class="images-grid">
                        ...
                        <div class="info-container">
                            ...
                            <p class="info">Sy No 105 F, H No 2-14/1, Shiva Reddy Godowns North NCL, NH44 Near Cine Planet Kompally, Hyderabad, Telangana 500014</p>
                        </div>
                        <div>
                            <a href="https://www.facebook.com/profile.php?id=61550737452869"
                                style="text-decoration: none;" target="_blank"><i
                                    class="fa-brands fa-square-facebook social-media-icon"></i></a>
                            <a href="https://www.instagram.com/telugu_aromas/?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"
                                style="text-decoration: none;" target="_blank"><i
                                    class="fa-brands fa-square-instagram social-media-icon"></i></a>
                            <a href="https://www.youtube.com/channel/UCaHxvSy_XUrWP9vovhTKQWA"
                                style="text-decoration: none;" target="_blank"><i
                                    class="fa-brands fa-square-youtube social-media-icon"></i></a>
                            <a href="https://www.threads.net/@telugu_aromas" style="text-decoration: none;"
                                target="_blank"><i class="fa-brands fa-square-threads social-media-icon"></i></a>
                        </div>
                    </div>
            ...
            <div class="location-information-container" id="kondapur">
                <div class="location-info">
                    <h1 class="title">Telugu Aromas - Kondapur</h1>
                    <div class="carousel-container mb-2">
                        <div class="item">
                            <div class="w-100 h-100 utility-background-property"
                ...
                <div class="location-image">
                    <div class="images-grid">
                        ...
                        <div class="info-container">
                            <p class="icon"><i class="fa-solid fa-phone"></i></p>
                            <p class="info">+91 90324 44819</p>
                            <p class="icon"><i class="fa-solid fa-envelope"></i></i></p>
                            <p class="info">takondapur.social@gmail.com</p>
                            <p class="icon"><i class="fa-solid fa-location-dot"></i></p>
                            <p class="info">Ground Floor, Sahiti Sudha Square, Gachibowli - Miyapur Rd, Hanuman Nagar, Shilpa Hills, Hyderabad, Telangana 500084</p>
                        </div>
                        <div>
                            <a href="https://www.facebook.com/profile.php?id=61550737452869"
                                style="text-decoration: none;" target="_blank"><i
                    ...
                    <div class="map-container">
                        <div class="py-2 w-100 h-100">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.88891813454!2d78.36769369999999!3d17.46503!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb932f778cd193%3A0x322c260e6a15ca06!2sTelugu%20Aromas%20Kondapur!5e0!3m2!1sen!2sin!4v1715799877438!5m2!1sen!2sin"
                                style="border:0;" allowfullscreen="" loading="lazy"
                                referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
            ...
            <div class="location-information-container" id="gowraram">
                <div class="location-info">
                    <h1 class="title">Telugu Aromas - Gowraram</h1>
                    <div class="carousel-container mb-2">
                        <div class="item">
                            <div class="w-100 h-100 utility-background-property"
                ...
                <div class="location-image">
                    <div class="images-grid">
                        ...
                        <div class="info-container">
                            <p class="icon"><i class="fa-solid fa-phone"></i></p>
                            <p class="info">+91 89771 47555</p>
                            <p class="icon"><i class="fa-solid fa-envelope"></i></i></p>
                            <p class="info">ta.gowraram@gmail.com</p>
                            <p class="icon"><i class="fa-solid fa-location-dot"></i></p>
                            <p class="info">Survey number 31/A, NH 44 mainroad, beside Indian Oil Petrol Bunk, Gowraram Village</p>
                        </div>
                        <div>
                            <a href="https://www.facebook.com/profile.php?id=61550737452869"
                                style="text-decoration: none;" target="_blank"><i
                    ...
                    <div class="map-container">
                        <div class="py-2 w-100 h-100">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3799.286862243875!2d78.662322!3d17.7782103!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcc7f000a546957%3A0x56288ccaf84ba7b!2sTelugu%20Aromas%20-%20Gowraram!5e0!3m2!1sen!2sin!4v1715799990176!5m2!1sen!2sin" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>

            <div class="location-information-container" id="toopran">
                <div class="location-info">
                ...
                <div class="location-image">
                    <div class="images-grid">
                        ...
                        <div class="info-container">
                            ...
                            <p class="icon"><i class="fa-solid fa-location-dot"></i></p>
                            <p class="info">S.no 743, Toopran bypass Road, National Highway 44, Toopran,Medak district,Telangana</p>
                        </div>
                        <div>
                            <a href="https://www.facebook.com/profile.php?id=61550737452869"
                                style="text-decoration: none;" target="_blank"><i
                    ...
                    <div class="map-container">
                        <div class="py-2 w-100 h-100">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3797.8860546067617!2d78.4673439!3d17.843975699999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcc7192814eb75d%3A0xbe3a6aab0f500486!2sTelugu%20Aromas!5e0!3m2!1sen!2sin!4v1715800163072!5m2!1sen!2sin" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
