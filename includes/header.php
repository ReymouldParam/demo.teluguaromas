              ...
              <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="../pages/ourstory.php">OUR STORY</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="../pages/catering.php">CATERING</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="../pages/franchise.php">FRANCHISE</a>
                        </li>
                        <!-- <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="../pages/location.php">LOCATION</a>
                          </li> -->
                        <li class="nav-item">
                            ...
                            <div class="social-icon-mobile">
                              <div class="icon-container">
                                  <div class="div">
                                      ...
                                      <a target="_blank" aria-label="our threads" href="https://www.threads.net/@teluguaromas"><img src="../assets/images/sm-logo/threads.png" alt=""></a>
                                    </div>
                              </div>
                          </div>
                        </li>
            ...
            <div class="hanger-img">
                <div class="icon-container">
                    <div class="div">
                        ...
                        <a target="_blank" aria-label="our threads" href="https://www.threads.net/@teluguaromas"><img alt="svgImg" src="../assets/images/threads-icon.png"/></a>
                      </div>
