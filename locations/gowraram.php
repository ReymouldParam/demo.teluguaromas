    ...
    <section class="locations-main-container">
        <div class="locations-list-container">
            ...
            <div class="py-1 bg-light h-100 overflow-auto list" style="border-radius: 0 10px 0 0">
                ...
                <a href="gowraram">
                    <div class="location-tab location-tab-active" data-location="gowraram">
        ...
        <div class="locations-main-body">
            <div class="location-information-container" style="display : flex" id="gowraram">
                <div class="location-info">
                    ...
                    <h2 class="sub-title">LOCATION: NH 44 mainroad, beside Indian Oil Petrol Bunk, Gowraram Village
                    </h2>
