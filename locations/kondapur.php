...
<head>
    ...
    <!-- Modified header links for locations -->
    <!-- boxicons -->
    ...
    <section class="locations-main-container">
        <div class="locations-list-container">
            ...
            <div class="py-1 bg-light h-100 overflow-auto list" style="border-radius: 0 10px 0 0">
                ...
                <a href="kondapur">
                    <div class="location-tab location-tab-active" data-location="kondapur">
        ...
        <div class="locations-main-body">
            <div class="location-information-container" style="display : flex" id="kondapur">
                <div class="location-info">
                    ...
                    <h2 class="sub-title">LOCATION: Miyapur Rd, Hanuman Nagar, Shilpa Hills, Hyderabad, Telangana</h2>
